...
public class Messages {
    public final String SELECTION_POS1, SELECTION_POS2, FULL_INVENTORY, WAND_SUCCESS, HELP,
            ...
            INFO_NOT_FOUND, INFO_DELIMITER, INFO_SUCCESS, INFO_NONE;
    ...
    public Messages(Config cfg) {
        ...
        INFO_NOT_FOUND = cfg.getString("info.not-found");
        INFO_DELIMITER = cfg.getString("info.delimiter");
        INFO_SUCCESS = cfg.getString("info.success");
        INFO_NONE = cfg.getString("info.none");
    }
}
